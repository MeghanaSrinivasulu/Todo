...
public class GetInProgressTasksServlet extends HttpServlet{

	public void doGet(HttpServletRequest request, HttpServletResponse response) {
		final Logger log = Logger.getLogger(GetInProgressTasksServlet.class.getName());
		DatastoreService datastore = DatastoreServiceFactory
				.getDatastoreService();
		
		log.warning("date" + new Date());
		Filter propertyFilter = new FilterPredicate("taskdate",FilterOperator.GREATER_THAN,new Date());
